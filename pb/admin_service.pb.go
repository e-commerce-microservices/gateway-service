...
type ReportShopRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ReportShopRequest) Reset() {
	*x = ReportShopRequest{}
...
func (x *ReportShopRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportShopRequest) ProtoMessage() {}

func (x *ReportShopRequest) ProtoReflect() protoreflect.Message {
	mi := &file_admin_service_proto_msgTypes[0]
...
// Deprecated: Use ReportShopRequest.ProtoReflect.Descriptor instead.
func (*ReportShopRequest) Descriptor() ([]byte, []int) {
	return file_admin_service_proto_rawDescGZIP(), []int{0}
}

type ReportShopResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ReportShopResponse) Reset() {
	*x = ReportShopResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReportShopResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportShopResponse) ProtoMessage() {}

func (x *ReportShopResponse) ProtoReflect() protoreflect.Message {
	mi := &file_admin_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportShopResponse.ProtoReflect.Descriptor instead.
func (*ReportShopResponse) Descriptor() ([]byte, []int) {
...
var file_admin_service_proto_rawDesc = []byte{
	...
	0x22, 0x13, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x68, 0x6f, 0x70, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x14, 0x0a, 0x12, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53,
	0x68, 0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x13, 0x0a, 0x11, 0x44,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x68, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x22, 0x14, 0x0a, 0x12, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x68, 0x6f, 0x70, 0x52, 0x65,
...
var file_admin_service_proto_goTypes = []interface{}{
	(*ReportShopRequest)(nil),  // 0: ecommerce.ReportShopRequest
	(*ReportShopResponse)(nil), // 1: ecommerce.ReportShopResponse
	(*DeleteShopRequest)(nil),  // 2: ecommerce.DeleteShopRequest
	(*DeleteShopResponse)(nil), // 3: ecommerce.DeleteShopResponse
}
...
func file_admin_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_admin_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportShopRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_admin_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportShopResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
